...
scene :: [Block]
scene = [ Block (Rectangle (-200) 200 100 90) white
        , Block (Rectangle (-200) 200 (-90) (-100)) white
        , Block (Rectangle (-5) 5 (-40) (-90)) white ]

p1paddle = Paddle (-150, 0) (Rectangle (-5) 5 25 (-25)) 200 (withKeys (Char 'a') (Char 'z'))
p2paddle = Paddle (150, 0)  (Rectangle (-5) 5 25 (-25)) 200 (withKeys (Char '\'') (Char '/'))
